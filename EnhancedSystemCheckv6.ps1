...
- Non-Microsoft tasks: $(try { Get-Content $MainLogFile -ErrorAction Stop | Where-Object { $_ -like "*Non-Microsoft scheduled*" } | Measure-Object | Select-Object -ExpandProperty Count } catch { 0 })
