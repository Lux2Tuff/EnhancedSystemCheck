...
function Invoke-MalwareDetection {
    ...
    foreach ($path in $pathsToScan) {
        try {
            ...
            Write-Log "Error scanning path $path: $_" "ERROR"
        }
    }
...
function Get-PCIeSlotData {
    ...
    foreach ($device in $pnpDevices) {
        try {
            ...
            Write-Log "Error processing PCIe device: $_" "ERROR"
        }
    }
}
...
"@
    try {
        ...
        Write-Log "Failed to generate summary markdown: $_" "ERROR"
    }
}
...
function Main {
    ...
    try {
        ...
        Write-Log "Failed to copy summary to clipboard: $_" "ERROR"
    }
